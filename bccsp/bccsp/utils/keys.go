...
var (
	...
	oidNamedCurveP256_sm2 = asn1.ObjectIdentifier{1, 2, 156, 10197, 1, 301}
)
...
func oidFromNamedCurve(curve elliptic.Curve) (asn1.ObjectIdentifier, bool) {
	...
	case sm2.P256_sm2():
		return oidNamedCurveP256_sm2, true
	}
	return nil, false
}
...
func PrivateKeyToDER(privateKey *sm2.PrivateKey) ([]byte, error) {
	...
	return x509.MarshalSM2PrivateKey(privateKey)
}
...
func PrivateKeyToPEM(privateKey interface{}, pwd []byte) ([]byte, error) {
	...
	default:
		return nil, errors.New("Invalid key type. It must be *rsa.PrivateKey or *sm2.PrivateKey")
	}
}
...
func PrivateKeyToEncryptedPEM(privateKey interface{}, pwd []byte) ([]byte, error) {
	...
	case *sm2.PrivateKey:
		...
		raw, err := x509.MarshalSM2PrivateKey(k)
...
func DERToPrivateKey(der []byte) (key interface{}, err error) {
	//log.Infof("DERToPrivateKey1")
	if key, err = x509.ParsePKCS1PrivateKey(der); err == nil {
		//log.Infof("DERToPrivateKey2")
		return key, nil
	}
	//log.Infof("DERToPrivateKey3")
	if key, err = x509.ParsePKCS8PrivateKey(der); err == nil {
		switch key.(type) {
		case *sm2.PrivateKey:
			//log.Infof("DERToPrivateKey4")
			return
		default:
			log.Infof("DERToPrivateKey5")
			return nil, errors.New("Found unknown private key type in PKCS#8 wrapping")
		}
	}
	log.Infof("DERToPrivateKey6")
	if key, err = x509.ParseSM2PrivateKey(der); err == nil {
		log.Infof("DERToPrivateKey7")
		return
	}

	return nil, errors.New("Invalid key type. The DER must contain an rsa.PrivareKey or ecdsa.PrivateKey or sm2.PrivateKey1")
}
...
func PEMtoPrivateKey(raw []byte, pwd []byte) (interface{}, error) {
	...
	//log.Infof("PEMtoPrivateKey5")
	cert, err := DERToPrivateKey(block.Bytes)
	if err != nil {
		log.Infof("PEMtoPrivateKey6")
		return nil, err
	}
	return cert, err
}
...
func PublicKeyToPEM(publicKey interface{}, pwd []byte) ([]byte, error) {
	...
	default:
		return nil, errors.New("Invalid key type. It must be *sm2.PublicKey or *rsa.PublicKey")
	}
}
