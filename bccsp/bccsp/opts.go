...
// SM2PKIXPublicKeyImportOpts包含以PKIX格式导入SM2公钥的选项
...
// SM2PrivateKeyImportOpts包含DER格式或PKCS＃8格式的SM2密钥输入选项。
...
// SM2GoPublicKeyImportOpts包含从sm2.PublicKey导入SM2密钥的选项
...
// SM2ReRandKeyOpts包含用于SM2密钥重新随机化的选项。
